...
# Set engine voor repositories (geen dependency injection nodig)
...
class UserRepository:
    ...
    def set_engine(cls, engine: Engine):
        """Set de database engine voor de repositories"""
        cls._engine = engine
...
class UserService:
    """Services voor User business logica"""
    ...
    def create_user(self, user_create: ApiUserCreate) -> ApiUser:
        ...
        # Sla op in database (geen repositories injectie nodig)
...
# Set engine voor repositories (moet voor router instantiatie)
UserRepository.set_engine(engine)
